...
function loadDataTable() {
    datatable = $('#tblDatos').DataTable({
        ...
        "ajax": {
            "url":"/Admin/Producto/ObtenerTodos"//Aqui se llama al método del controlador
        },
        "columns": [
            {"data": "numeroSerie"},
            { "data": "descripcion"},
            ...
            { "data": "marca.nombre" },
            {
                ...
                "render": function (data) {
                    var d = data.toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,')//Expresion regular para transformar en formato de precio
                    return d;
                }
            },
            { 
